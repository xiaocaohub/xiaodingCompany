      ...
      <div class="basic-info">
        ...
        <div class="basic-block">
          ...
          >
            ...
            <!-- <el-dialog :visible.sync="dialogVisibleUploadImage">
            ...
            <div style="border:1px solid transparent;">
                ...
                <el-table
                  ...
                  <el-table-column
                    ...
                    width="100">
                      <template slot-scope="scope">
                          <el-input type="text" v-model="scope.row.bom_nums"  style="width:79px;"  @blur="updateKindTableDataAll(scope.row)"></el-input>
                      </template>
                  </el-table-column>
                  ...
                  <el-table-column
                    ...
                    width="100">
                      <template slot-scope="scope">
                          <el-input type="text" v-model="scope.row.vol"  style="width:75px;" @blur="updateKindTableDataAll(scope.row)"></el-input>
                      </template>
                  </el-table-column>
      ...
      <div class="detail-container">
        ...
        <div class="detail-block">
          <el-form-item
            ...
            v-show="this.pageType == 'editor'?false: true"
          >
            <div class="upload-box">
              <div class="avatar-uploader-box">
                <div
      ...
      <!--规格属性弹窗 -->
        ...
        <el-dialog
           ...
           <!-- <el-upload
                ...
                multiple
                :limit="6"
                 :on-change="tableChangeUploadFn"
                list-type="picture-card"
                :file-list="tableUploadFileList"
                :on-exceed="handleExceed"
                :auto-upload="false">           
                    <i slot="default" class="el-icon-plus"></i>
                    <div slot="file" slot-scope="{file}">
  ...
  methods: {
    ...
    editLoadSelectKindDataFn () {
        ...
        editGetKindData({
            ...
            _this.kindData = eval(res.data.data.sku_attribute);
        })
    },
    // 规格颜色
    loadSelectColorFn () {
    ...
    blurChangeKindFn (changeItem) {
        console.log("blurChangeKindFn", changeItem)
        // this.focusStatus = "change";
        ...
        // console.log("blurChangeKindFn kindTableData", kindTableData)
        // console.log("blurChangeKindFn kindTableDataAll", kindTableDataAll)
    ...
    submitForm (formName) {
      ...
      //     attr_list: [
      //         {
      //           attr_group_name: "颜色",attr_id: "", attr_name: "灰色"
      //         },
      //         {
      //           attr_group_name: "规格", attr_id: "", attr_name: "1-2KG/只"
      //         }
      //     ],
      //     bar_code: "1",
      //     capacity: "1",  // 体积
      //     cbj: "1", // 采购价
      //     cid: "1",
      //     img: "https://luockoo.oss-cn-shenzhen.aliyuncs.com/1/1/20240711/1811331301556338688.png",
      //     kucun: "1000", // 库存
      //     sj: "1",
      //     unit: "1",
      //     yj: "1",
      ...
      //         },
      //         {
      //           attr_group_name: "规格", attr_id: "", attr_name: "2-3KG/只"
      //         }
      //     ],
      //     bar_code: "1",
      //     capacity: "1",   // 体积
            ...
            $.ajax({
              ...
              data: {
               ...
               // attrArr: JSON.stringify(strList),
                ...
                // 规格
                skuAttribute: JSON.stringify(this.kindData),
                // 商品设置
