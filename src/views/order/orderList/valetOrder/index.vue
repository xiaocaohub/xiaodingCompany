<template>
  <div class="container">
        ...
        <div class="flex">
            ...
            <div class="changeUser" style="max-height: 350px;">
                ...
                <el-table :data="tableData" style="max-height: 350px;" v-if="tableData.length > 0" :header-cell-style="header">
                    ...
                    <el-table-column prop="zhanghao" align="center" label="用户账号">
                    </el-table-column>
                    <el-table-column prop="grade" align="center" label="用户等级">
                    </el-table-column>
    ...
    <el-dialog title="选择用户" :visible.sync="dialogVisible" width="920px">
        <div class="">
            <div class="Search">
                <el-select class="Search-select" clearable v-model="gradeValue" placeholder="请选择用户级别">
                    <el-option v-for="(item,index) in gradeList" :key="index" :label="item.label" :value="item.value">
                    </el-option>
                </el-select>
                <el-input class="Search-input" v-model="search" placeholder="请输入用户ID/用户名称/手机号"></el-input>
                <el-button @click="Reset" plain>重置</el-button>
                <el-button @click="query2" type="primary" v-enter="query2">查询</el-button>
            </div>
            <div class="Table">
                <el-table height="350" :data="userdata"  style="width: 100%" @current-change="handleSelectionChange">
                    ...
                    <el-table-column prop="user_name" align="center" label="用户名称">
                    </el-table-column>
                    <el-table-column prop="mobile" align="center" label="手机号码">
                    </el-table-column>
                    <el-table-column prop="grade" align="center" label="用户等级">
    ...
    <el-dialog title="添加商品" :visible.sync="dialogVisible3" width="920px">
        <div class="">
            ...
            <div class="Search" style="margin-top: 20px;">
                ...
                <el-button @click="Reset" plain>重置</el-button>
                <el-button @click="query" type="primary" v-enter="query">查询</el-button>
            </div>
