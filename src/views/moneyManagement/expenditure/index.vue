  ...
  <div class="container">
      ...
      <div class="Search-condition">
        <div class="query-input">
          <div class="select-date">
            <el-input
              v-model="inputInfo.oid"
              size="medium"
              class="Search-input"
              :placeholder="$t('accountingRecords.qsrddh')"
    ...
    <div class="menu-list" ref="tableFather">
      ...
      >
        ...
        <el-table-column prop="remake" :label="$t('accountingRecords.ddh')">
        </el-table-column>
        <el-table-column prop="price" :label="$t('accountingRecords.czje')">
          <template slot-scope="scope">
            <span v-if="scope.row.price">{{ scope.row.price.toFixed(2) }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="type" :label="$t('accountingRecords.czlx')">
          <template slot-scope="scope">
            <span v-if="scope.row.type == 1">订单</span>
            ...
            <span v-if="scope.row.type == 5">供应商订单</span>
          </template>
        </el-table-column>
        <el-table-column
          prop="addtime"
          :label="$t('accountingRecords.czsj')"
          width="185"
        >
          <template slot-scope="scope">
...
<script>
import { revenueRecords } from '@/api/moneyManagement/expenditure'
