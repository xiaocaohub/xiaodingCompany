  ...
  <div class="container">
    <div class="add-menu">
      ...
      >
        ...
        <el-form-item
          :label="$t('permissions.addmenulevel.sjcd')"
          prop="superiorclass"
          v-if="inputShow !== 1"
        >
          <div class="superior">
...
export default {
  ...
  created () {
    ...
    this.ruleForm.menuname = this.$route.params.name
    this.ruleForm.path = this.$route.params.path
    this.ruleForm.is_core = this.$route.params.is_display
    this.ruleForm.menulocal = this.$route.params.url
    this.ruleForm.defaultLogo = this.$route.params.logo
    this.ruleForm.selectLogo = this.$route.params.checked_logo
    this.ruleForm.tourintroduction = this.$route.params.text
