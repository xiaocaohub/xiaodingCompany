  ...
  methods: {
    ...
    async getList() {
      const res = await getList({
        ...
        invoiceStatus: this.inputInfo.status,
    ...
    handleUploadError (err, file, fileList) {
      console.log(
        'xxxxxxxxxxxxxxxxxxxxxxxxerr, file, fileList',
        err,
        file,
        fileList
      )
    ...
    handleEditChange (file, fileList) {
      console.log('fileList1231231231231312', file, fileList)
    ...
    handleBeforeUpload (file, fileList) {
      console.log(this.$refs.img_upload.uploadFiles)
