...
export const getKindData = params=>{
    return request({
...
export const editGetKindData = params=> {
...
export const getBrandData = params=> {
    return request({
        method: "POST",
        params
    })
...
export const uploadGetId = params => {
    return request({
        method: "POST",
        params
    })
