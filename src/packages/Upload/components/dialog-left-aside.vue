<template>
  <div class="dialog-left-aside">
    <el-aside class="aside" style="width: 280px;">
      <el-menu
...
export default {
  ...
  methods: {
    ...
    async queryClassifys() {
      // console.log("groupName",groupName)
      await api.getClassify(this.groupName).then(res => {
        this.classify_list = res.data.data.list
      })
    },
...
.el-menu-item span:first-child:hover{
